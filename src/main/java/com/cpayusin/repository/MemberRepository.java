...
import com.cpayusin.payload.response.member.MemberScoreResponse;
import com.cpayusin.payload.response.member.MemberSingleResponse;
...
public interface MemberRepository extends JpaRepository<Member, Long>, MemberRepositoryCustom
{
    ...
    @Query("SELECT new com.cpayusin.payload.response.member.MemberSingleResponse(m.id, m.nickname, m.url, m.role) FROM Member m " +
