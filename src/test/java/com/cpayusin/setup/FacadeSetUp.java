...
public class FacadeSetUp extends MockSetup
{
    ...
    protected List<Member> memberEntities;
    ...
    void threadSetUp()
    {
        ...
        List<Member> mockMemberEntities = List.of(member1, member2, member3, member4, member5, member6, member7, member8, member9, member10);
